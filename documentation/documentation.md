...
![command to make the help jest detect the tests](https://github.com/solitontech/WebTips_Starter_Repo/blob/main/documentation/assets/WorkflowSpecification/jestSpecification.PNG)
